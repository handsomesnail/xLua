...
@REM 不编译32位版本
@REM mkdir build32_54 & pushd build32_54
@REM cmake -DLUA_VERSION=5.4.1 -G "%__VS%" -A Win32 ..
@REM popd
@REM cmake --build build32_54 --config Release
@REM md plugin_lua54\Plugins\x86
@REM copy /Y build32_54\Release\xlua.dll plugin_lua54\Plugins\x86\xlua.dll
